    ...
    <>
      ...
      <section className="bg-paper py-20">
        <Container className="max-w-3xl space-y-6 text-base leading-relaxed text-ink/75">
          ...
          <p>
            To access, correct, or delete information we hold about you from this site, email hello@zenoratech.systems. We will respond within a reasonable period.
          </p>
          <p>
    ...
    <>
      ...
      <section className="bg-paper py-20">
        <Container className="max-w-3xl space-y-6 text-base leading-relaxed text-ink/75">
          ...
          <p>Governing conversations about this site can be addressed to hello@zenoratech.systems.</p>
          <Link to="/" className="inline-block text-sm">
            ← Home
          </Link>
        </Container>
